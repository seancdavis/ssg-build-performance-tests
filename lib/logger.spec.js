...
//
describe("new Logger()", () => {
  it.skip("throws an error when no dataset is specified", () => {
    expect(() => {
      logger = new Logger({})
    }).toThrow()
  })
  it.skip("has proper defaults", () => {
...
describe("generateTimestamp()", () => {
  it.skip("returns an integer of the current time", () => {
...
describe("storeResult()", () => {
  ...
  it.skip("nests them in a dataset, name, and count key", () => {
    expect(logger.results).toEqual({})
  ...
  it.skip("requires name and count to be included", () => {
    expect(() => {
      logger.storeResult({ foo: "bar" })
    }).toThrow()
  })
  it.skip("only stores the three most recent", () => {
  ...
  it.skip("includes any passed key-value pairs", () => {
...
describe("writeFile()", () => {
  it.skip("writes the results to file", () => {
    logger = new Logger("base", mockConfig)
